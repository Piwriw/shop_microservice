...
type OrderInfo struct {
	...
	OrderMount float32
	PayTime    *time.Time `gorm:"type:datetime comment '支持时间'"`

	Address      string `gorm:"type:varchar(100) comment '收获地址'"`
	SignerName   string `gorm:"type:varchar(20) comment '收货人姓名'"`
	SingerMobile string `gorm:"type:varchar(11) comment '收货人联系方式'"`
